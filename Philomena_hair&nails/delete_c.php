...
if (isset($_GET['hetid'])) {
    ...
    if (isset($_GET['confirm'])) {
        ...
        WHERE appointment.id = ?";
            ...
            $stmt->execute([$_GET['hetid']]);
            $msg = "Afspraak is verwijderd! <br> <a href='appointments_c.php'>Terug naar afspraken</a>";
        } else {
            // User clicked the "No" button and it will redirect them back to the appointment page
            header('Location: appointments_c.php');
            echo "did not work";
            exit;
        }
    }
...
<div class="content delete">
    ...
    <div class="yesno">
        <a href="delete_c.php?hetid=<?=$app['id']?>&confirm=Ja">Ja</a>
        <a href="delete_c.php?hetid=<?=$app['id']?>&confirm=Nee">Nee</a>
    </div>
    <?php endif; ?>
</div>
